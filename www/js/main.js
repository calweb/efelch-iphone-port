...
function startGame() {
    if (window.device)
    {
        ...
        backgroundMedia = createAudio("guile_music.mp3", backgroundMedia);
        backgroundMedia.play();

        allyMedia = createAudio("catwail.wav", allyMedia);
        enemyMedia1 = createAudio("ninjastar.mp3", enemyMedia1);
        enemyMedia2 = createAudio("ninjastar.mp3", enemyMedia2);
    }
